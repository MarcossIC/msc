...
pub fn get_file_icon(filename: &str) -> &'static str {
    ...
    if let Some(ext) = path.extension() {
        match ext.to_str().unwrap_or("").to_lowercase().as_str() {
            ...
            "cs" => "🟣",
            "rb" => "💎",
            "dart" | "scala" | "hs" | "clj" | "cljs" | "cljc" | "ex" | "exs" | "m" | "f90"
            | "for" | "jl" | "c" | "cpp" | "tsv" => "📘",
            // Web
            "html" | "htm" => "🌐",
            "rst" => "🌐",
            ...
            "xml" => "📰",
            "yaml" | "yml" | "uml" | "toml" => "📒",
            "ini" | "cfg" | "conf" | ".editorconfig" | ".dockerignore" | ".gitignore"
            | ".gitattributes" => "⚙",
            "env" => "🌱",
            "sql" | "sqlite" | "sqlite3" | "db" | "mdb" | "accdb" | "dbf" | "parquet" | "avro"
            | "orc" => "🗄️",
            // Documents
            "md" => "📖",
            "txt" => "📝",
            ...
            "odt" | "ods" | "odp" => "📄",
            // Images
            "jpg" | "jpeg" | "png" | "gif" | "bmp" | "tiff" | "webp" | "heic" | "psd" | "ai"
            | "xcf" => "🖼️",
            "ico" => "🎯",
            // Fonts
            "ttf" | "otf" | "woff" | "woff2" => "🔤",
            ...
            // Archives
            "zip" | "rar" | "7z" | "tar" | "gz" | "tgz" | "bz2" | "iso" | "cab" | "zst"
            | "lzma" | "xz" => "📦",
            // Executables
            "exe" | "msi" | "deb" | "rpm" | "dmg" => "⚡",
            "apk" | "ipa" => "📱",
        ...
        match name_lower.as_str() {
            "head" | "config" | "description" | "exclude" | "hooks" | "info" | "objects"
            | "refs" => "⚙",
