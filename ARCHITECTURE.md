...
- **Crate**: Paquete de Rust (equivalente a package en otros lenguajes)
- **Module**: Unidad de organización de código dentro de un crate
- **Trait**: Interfaz que define comportamiento compartido
- **Lifetime**: Anotación que indica cuánto tiempo vive una referencia
- **Borrow**: Referencia temporal a un valor sin tomar ownership
- **Ownership**: Sistema de gestión de memoria único de Rust
- **Pattern Matching**: Técnica para extraer valores de enums y structs

---

## Conclusión

Esta arquitectura está diseñada para crecer con el proyecto manteniendo:

- **Claridad**: Fácil encontrar dónde está cada cosa
- **Mantenibilidad**: Cambios localizados, bajo acoplamiento
- **Testabilidad**: Lógica de negocio separada de I/O
- **Extensibilidad**: Fácil agregar nuevas funcionalidades

Cuando tengas dudas sobre dónde colocar código nuevo, pregúntate:

1. ¿Es UI, lógica de negocio, o infraestructura?
2. ¿Tiene dependencias de otras capas?
3. ¿Es testeable de forma aislada?

Estas preguntas te guiarán a la capa correcta.
